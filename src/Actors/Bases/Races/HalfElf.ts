...
export class HalfElf extends Actor {
  ...
  private addAnimations() {
    ...
    const downIdle = new Animation({
      frames: [
        {
          graphic: accursedSpriteSheet.getSprite(1, 0),
          duration: 200,
        },
      ],
    });
    ...
    const leftIdle = new Animation({
      frames: [
        {
          graphic: accursedSpriteSheet.getSprite(1, 1) as Sprite,
          duration: 200,
        },
      ],
    });
    ...
    const rightIdle = new Animation({
      frames: [
        {
          graphic: accursedSpriteSheet.getSprite(1, 2) as Sprite,
          duration: 200,
        },
      ],
    });
    ...
    const upIdle = new Animation({
      frames: [
        {
          graphic: accursedSpriteSheet.getSprite(1, 3) as Sprite,
          duration: 200,
        },
      ],
    });
